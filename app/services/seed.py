...
DEFAULT_RULES = [
    ...
    ("AP-003", "RULE-RETRACEMENT-LRHR", "Prefer LRHR retracement zone", {"conditions": [{"field": "retracement_pct", "op": ">=", "value": 38.2}, {"field": "retracement_pct", "op": "<=", "value": 78.6}]}, "Pullback entries in the 38.2/50/61.8/78.6 LRHR zone should be preferred over chase entries."),
