...
if selected_performance:
    ...
    cols[1].metric("Remaining", selected_performance.get("remaining_review_trades"))
    cols[2].metric("Open", selected_performance.get("open_trades"))
    cols[3].metric("Net P&L", selected_performance.get("net_realized_pnl"))
    cols[4].metric("Profit Factor", selected_performance.get("profit_factor_label"))
    cols[5].metric("Review Ready", str(selected_performance.get("forward_review_ready")))
